...
class vgg16_pn():
    ...
    def load_model(self):
        ...
        self.pn_judge_model.load_state_dict(torch.load("model_code/vgg16-397923af.pth"))
        ...
        pn_judge_model_save_path = 'model_code/Pneumonia_model.pt'
        self.pn_judge_model.load_state_dict(torch.load(pn_judge_model_save_path))
