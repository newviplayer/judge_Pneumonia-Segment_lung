...
class alexnet_pn():
    ...
    def load_model(self):
        ...
        self.pn_judge_model.load_state_dict(torch.load("model_code/model_weights_AlexNet.pth"))
        # self.pn_judge_model.load_state_dict(torch.load('/home/KHD/model_weights_AlexNet.pth', map_location=self.device))
